...
public class GenJavaCode {
     ...
     * for idea
     */
    private String javaFilePath = "kpt_svc";
    private String authorName = "administrator";
    String baseOutputFiePath = javaFilePath + "/src/main/java/";

    private String fullDomainClassName = "com.rjxx.taxeasy.dao.bo.ShortLink";
    private String tableName = "t_short_link";
    ...
    private String daoPackageName = "com.rjxx.taxeasy.dao.orm";
    ...
    private void buildMapperJavaContent() {
        ...
        mapperJavaStringBuilder.append("import com.rjxx.taxeasy.dao.bo." + simpleDomainClassName + ";\r\n");
        mapperJavaStringBuilder.append("\r\n");
