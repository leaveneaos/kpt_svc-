...
public class ShortUrl {
    ...
    public static void main(String[] args) {
        System.out.println(ShortUrl.getShortUrl("xlm","http://test.datarj.com/e-invoice-file/1/500102010003643/20180518/20180518_12312473_富士胶片（中国）投资有限公司_10457.pdf"));
    }


    public  static   String getShortUrl(String key,String longUrl) {
        //将产生4组6位字符串
        String[] aResult = shortUrl(key,longUrl);
