...
import com.rjxx.taxeasy.dingding.Helper.*;
...
public class ServiceHelper {
	...
	public static CorpAuthToken getIsvCorpToken(String auth_corpid, String permanent_code, String suiteAccessToken )throws Exception{
		ServiceFactory serviceFactory = ServiceFactory.getInstance();
		IsvService isvService = serviceFactory.getOpenService(IsvService.class);
