...
public class AuthHelper {
	...
	public static String getCorpAccessToken(String corpId, String suitetoken, String permanentCode) throws Exception {
	...
	// 正常的情况下，jsapi_ticket的有效期为7200秒，所以需要在某个地方设计一个定时器，定期去更新jsapi_ticket
	...
	public static String getAgentId(String corpId, String appId) throws Exception {
		String agentId = null;
