...
public class SocketService {
    ...
    public String skBoxKP(String p) throws Exception{
        ...
        try {
            ...
            ServerHandler.sendSocketMessage("NewInvoice",Ruquest,false, 0);
        }catch (Exception e){
            e.printStackTrace();
        }
        return null;
    ...
    public String inputUDiskPassword(int skpid) throws Exception{
        ...
        String  Ruquest= PacketBody.getInstance().Packet_Ruquest(PasswordConfig.AppID,"DeviceCmd",DeviceCmd);
        String  result= ServerHandler.sendSocketMessage("InputUDiskPassword",Ruquest,true, 60000);
        return  result;
    }
    ...
    public String deviceAuth(int skpid) throws Exception{
        ...
        String  result=ServerHandler.sendSocketMessage("DeviceAuth",Ruquest,true, 60000);
        return  result;
    }
    ...
    public String deviceState(int skpid) throws Exception{
        ...
        String  result= ServerHandler.sendSocketMessage("DeviceState",Ruquest,true, 60000);
        return  result;
    }
    ...
    public String InvalidateInvoice(String p) throws  Exception{
        try {
            ...
            String  Ruquest= PacketBody.getInstance().Packet_Ruquest(PasswordConfig.AppID,"DeviceCmd",DeviceCmd);
            String  result=ServerHandler.sendSocketMessage("InvalidateInvoice",Ruquest,true, 60000);
            return  result;
        }catch (Exception e){
            e.printStackTrace();
            return null;
    ...
    public String GetUploadStates(int skpid) {
        try {
            ...
            String  Ruquest= PacketBody.getInstance().Packet_Ruquest(PasswordConfig.AppID,"DeviceCmd",DeviceCmd);
            String result= ServerHandler.sendSocketMessage("GetUploadStates",Ruquest,true, 60000);
            return  result;
        }catch (Exception e){
            e.printStackTrace();
            return null;
    ...
    public String TriggerUpload(int skpid) {
        try{
            ...
            String  Ruquest= PacketBody.getInstance().Packet_Ruquest(PasswordConfig.AppID,"DeviceCmd",DeviceCmd);
            String  result=ServerHandler.sendSocketMessage("TriggerUpload",Ruquest,true, 60000);
            return  result;
        }catch (Exception e){
            e.printStackTrace();
            return null;
    ...
    public String GetDeclareTaxStates(int skpid) {
        try {
            ...
            String  Ruquest= PacketBody.getInstance().Packet_Ruquest(PasswordConfig.AppID,"DeviceCmd",DeviceCmd);
            String result=ServerHandler.sendSocketMessage("GetDeclareTaxStates",Ruquest,true, 60000);
            return  result;
        }catch (Exception e){
            e.printStackTrace();
            return null;
    ...
    public String TriggerDeclareTax(int skpid) {
        try {
            ...
            String  Ruquest= PacketBody.getInstance().Packet_Ruquest(PasswordConfig.AppID,"DeviceCmd",DeviceCmd);
            String  result= ServerHandler.sendSocketMessage("TriggerDeclareTax",Ruquest,true, 60000);
            return  result;
        }catch (Exception e){
            e.printStackTrace();
            return null;
    ...
    public String UDiskInfo(int skpid) {
        try {
            ...
            String  Ruquest= PacketBody.getInstance().Packet_Ruquest(PasswordConfig.AppID,"DeviceCmd",DeviceCmd);
            String  result = ServerHandler.sendSocketMessage("UDiskInfo",Ruquest,true, 60000);
            return  result;
        }catch (Exception e){
            e.printStackTrace();
            return null;
    ...
    public String InvoiceControlInfo(int skpid) {
        try {
            ...
            String  Ruquest= PacketBody.getInstance().Packet_Ruquest(PasswordConfig.AppID,"DeviceCmd",DeviceCmd);
            String  result =ServerHandler.sendSocketMessage("InvoiceControlInfo",Ruquest,true, 60000);
            return  result;
        }catch (Exception e){
            e.printStackTrace();
            return null;
    ...
    public String GetCurrentInvoiceInfo(String p) throws Exception{
        try {
            ...
            String  Ruquest= PacketBody.getInstance().Packet_Ruquest(PasswordConfig.AppID,"DeviceCmd",DeviceCmd);
            String  result=ServerHandler.sendSocketMessage("GetCurrentInvoiceInfo",Ruquest,true, 60000);
            return  result;
        }catch (Exception e){
            e.printStackTrace();
            return null;
    ...
    public String GetAllInvoiceSections(int skpid) {
        ...
        try {
            ...
            for(int i=0;i<kplx.length;i++){
                ...
                String  Ruquest= PacketBody.getInstance().Packet_Ruquest(PasswordConfig.AppID,"DeviceCmd",DeviceCmd);
                String  result=ServerHandler.sendSocketMessage("GetAllInvoiceSections",Ruquest,true, 60000);
                result+=resultThree;
            }
            return resultThree;
        }catch (Exception e){
    ...
    public String InvoiceDistribute(Map map) {
       ...
       try{
           ...
           String  Ruquest= PacketBody.getInstance().Packet_Ruquest(PasswordConfig.AppID,"DeviceCmd",DeviceCmd);
           String  result=ServerHandler.sendSocketMessage("InvoiceDistribute",Ruquest,true, 60000);
           return  result;
       }catch (Exception e){
           e.printStackTrace();
           return null;
    ...
    public String UDiskBinding(int skpid) {
        try{
            ...
            String  Ruquest= PacketBody.getInstance().Packet_Ruquest(PasswordConfig.AppID,"DeviceCmd",DeviceCmd);
            String result=ServerHandler.sendSocketMessage("UDiskBinding",Ruquest,true, 60000);
            return result;
        }catch (Exception e){
            e.printStackTrace();
            return null;
    ...
    public String SwitchUDisk(int skpid) {
        try{
            ...
            String  Ruquest= PacketBody.getInstance().Packet_Ruquest(PasswordConfig.AppID,"DeviceCmd",DeviceCmd);
            String result=ServerHandler.sendSocketMessage("SwitchUDisk",Ruquest,true, 60000);
            return result;
        }catch (Exception e){
            e.printStackTrace();
            return null;
    ...
    public String DeviceInfo(int skpid) {
        ...
        try{
            ...
            String  Ruquest= PacketBody.getInstance().Packet_Ruquest(PasswordConfig.AppID,"DeviceCmd",DeviceCmd);
            String result= ServerHandler.sendSocketMessage("DeviceInfo",Ruquest,true, 60000);
            return result;
        }catch (Exception e){
            e.printStackTrace();
            return null;
    ...
    public String FactoryReset(int skpid) {
        try{
            ...
            String  Ruquest= PacketBody.getInstance().Packet_Ruquest(PasswordConfig.AppID,"DeviceCmd",DeviceCmd);
            String result=ServerHandler.sendSocketMessage("FactoryReset",Ruquest,true, 60000);
            return result;
        }catch (Exception e){
            e.printStackTrace();
            return null;
