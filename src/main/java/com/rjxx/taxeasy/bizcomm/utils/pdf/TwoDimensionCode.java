...
public class TwoDimensionCode {
     ...
     * @return
     */
    public BufferedImage getEncoderQrCodeBuffer(String content) {
        BufferedImage bufImg = this.qRCodeCommon(content, "png", 7);
        return bufImg;
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println(Base64.encodeBase64String(output.toByteArray()));
        } catch (Exception e) {
            e.printStackTrace();
        }
